<?php
namespace App\Libraries\PaySera\WebToPay;
use App\Libraries\PaySera\WebToPay\Sign\SignCheckerInterface;
...
class WebToPay_CallbackValidator {
     ...
     */
    public function __construct($projectId, SignCheckerInterface $signer, WebToPay_Util $util) {
        $this->signer = $signer;
        $this->util = $util;
