...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__components_Home_vue__ = __webpack_require__(47);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_vue_carousel__ = __webpack_require__(49);
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    methods: {
        setPackage: function setPackage(productIndex, packageIndex, id, name, type, price) {
            if (type == 'new') {
        ...
        getContact: function getContact() {
            ...
            __WEBPACK_IMPORTED_MODULE_0_axios___default.a.get('get-contacts-home').then(function (response) {
        ...
        getNewProducts: function getNewProducts() {
            ...
            __WEBPACK_IMPORTED_MODULE_0_axios___default.a.get('get-new-products').then(function (response) {
                // console.log(response.data)
                _this2.newProducts = response.data;
            });
        },
        getBestProducts: function getBestProducts() {
            var _this3 = this;

            __WEBPACK_IMPORTED_MODULE_0_axios___default.a.get('get-best-products').then(function (response) {
                //console.log(response.data)
                _this3.bestProducts = response.data;
            });
        },
        getBestProductBanners: function getBestProductBanners() {
            var _this4 = this;

            __WEBPACK_IMPORTED_MODULE_0_axios___default.a.get('get-best-product-banners').then(function (response) {
                _this4.bestBanners = response.data;
            });
        },
        getNewProductBanners: function getNewProductBanners() {
            var _this5 = this;

            __WEBPACK_IMPORTED_MODULE_0_axios___default.a.get('get-new-product-banners').then(function (response) {

                _this5.newBanners = response.data;
            });
        },
        addToCart: function addToCart(productIndex, productId, type) {
            var _this6 = this;

            this.cart.productId = productId;
            this.cart.quantity = document.getElementById('quantity_' + productId).value;

            if (type == 'new_product') this.cart.package = this.newProducts[productIndex].selectedPackageId;else this.cart.package = this.bestProducts[productIndex].selectedPackageId;

            __WEBPACK_IMPORTED_MODULE_0_axios___default.a.post('add-to-cart', this.cart).then(function (response) {
                if (response.data.message == undefined) {
                    _this6.added.push(productId);
                    _this6.getCartProductNumbers();
                } else {
                    alert(response.data.message);
                }
            });
        },
        changeQuantityOrAdd: function changeQuantityOrAdd(productIndex, productId, type) {
            var _this7 = this;
            ...
            __WEBPACK_IMPORTED_MODULE_0_axios___default.a.post('if-cart-product-exists', this.cart).then(function (response) {
                exists = response.data;
                console.log(exists);
                var that = _this7;
                if (exists == true) {
                    __WEBPACK_IMPORTED_MODULE_0_axios___default.a.post('add-item-quantity', _this7.cart).then(function (response) {
                        that.getCartProductNumbers();
                    });
                } else {
                    __WEBPACK_IMPORTED_MODULE_0_axios___default.a.post('add-to-cart', that.cart).then(function (response) {
                        if (response.data.message == undefined) {
        ...
        getCartProductNumbers: function getCartProductNumbers() {
            var _this8 = this;

            __WEBPACK_IMPORTED_MODULE_0_axios___default.a.get('get-cart-number').then(function (response) {
                _this8.cartItemNumber = response.data;
            });
        },
        removeFromCart: function removeFromCart(productId) {
            var _this9 = this;

            var index = this.added.indexOf(productId);
            this.added.splice(index, 1);
            this.cart.productId = productId;
            __WEBPACK_IMPORTED_MODULE_0_axios___default.a.post('remove-from-product', this.cart).then(function (response) {

                _this9.getCartProductNumbers();
            });
        },
        increaseClickCount: function increaseClickCount(id) {
            __WEBPACK_IMPORTED_MODULE_0_axios___default.a.get('increase-banner-click/' + id).then(function (response) {
                console.log(response.data);
            });
        },
        getAdvantages: function getAdvantages() {
            ...
            __WEBPACK_IMPORTED_MODULE_0_axios___default.a.get('get-advantages-home').then(function (response) {
                _this10.advantages = response.data;
            });
        }
    },
    components: { VueCarousel: __WEBPACK_IMPORTED_MODULE_1_vue_carousel___default.a }
});
...
var render = function() {
  ...
  return _c("div", [
    _c("div", { attrs: { id: "scroll_nav_block" } }, [
      _c("div", { staticClass: "container" }, [
        _c("div", { staticClass: "row py-2" }, [
          _c("div", { staticClass: "col-sm-6 col-md-6 col-lg-3" }, [
            _c("div", { staticClass: "d-flex" }, [
              _c("div", { staticClass: "input-group input-group-sm my-2" }, [
                _c("input", {
                  directives: [
                    {
                      name: "model",
                  ...
                  staticClass: "form-control border-right-0 border",
                  attrs: { type: "search", id: "example-search-input" },
          ...
          _vm._m(1),
          _vm._v(" "),
          _c("div", { staticClass: "col-sm-6 col-md-6 col-lg-1" }, [
            _c(
              "div",
              {
                staticClass:
                  "d-flex justify-content-sm-end justify-content-md-end justify-content-lg-start"
              },
              [
                _c("div", { staticClass: "cart_circle_container" }, [
                  _vm._m(2),
                  _vm._v(" "),
                  _c("div", { staticClass: "cart_circle_counter_container" }, [
                    _c("div", { staticClass: "cart_circle_counter1" }, [
                      _vm._v(_vm._s(_vm.cartItemNumber))
                    ])
                  ])
                ])
              ]
    ...
    _c("div", { staticClass: "container" }, [
      _c(
        ...
        _vm._l(_vm.newBanners, function(newBanner) {
          return _c("div", { staticClass: "col-sm-6 col-md-6 col-lg-6" }, [
            _c("div", { staticClass: "card" }, [
              _c(
                "a",
                {
                  attrs: { href: newBanner.link },
                  on: {
                    click: function($event) {
                      _vm.increaseClickCount(newBanner.id)
                    }
                  }
                },
                [
                  _c("img", {
                    ...
                    attrs: { src: newBanner.image, alt: "yzipet" }
                  })
                ]
              )
            ])
    ...
    _c("div", { staticClass: "container" }, [
      _c(
        ...
        _vm._l(_vm.newProducts, function(newProduct, index) {
          return _c("div", { staticClass: "col-sm-6 col-md-4 col-lg-3 mb-3" }, [
            _c("div", { attrs: { id: "home_product_item_frame" } }, [
              _c("div", { staticClass: "d-flex justify-content-center" }, [
                _c(
                  "a",
                  {
                    staticClass: "home_product_item_picframe",
                    attrs: { href: "#" }
                  },
                  [
                    _c("img", {
                      staticClass: "img-fluid",
                      attrs: { src: newProduct.image, alt: "yzipet" }
                    })
                  ]
                )
              ]),
              ...
              _c(
                ...
                {
                  staticClass:
                    "d-sm-flex d-md-flex d-lg-flex mt-4 home_product_com_logo"
                },
                [
                  _c("a", { attrs: { href: "#" } }, [
                    _c("img", {
                      staticClass: "img-fluid home_product_com_logo",
                      attrs: {
                        src: newProduct.manufacturerPhoto,
                        alt: "yzipet"
                      }
                    })
                  ])
              ...
              _vm._v(" "),
              _c("div", { staticClass: "d-sm-flex d-md-flex d-lg-flex mt-3" }, [
                _c(
                  "a",
                  {
                    staticClass: "home_product_title_link",
                    attrs: { href: newProduct.detailLink }
                  },
                  [_vm._v(_vm._s(newProduct.title))]
                )
              ]),
              _vm._v(" "),
              _c(
                ...
                {
                  staticClass:
                    "d-sm-inline-flex d-md-inline-flex d-lg-inline-flex mb-3"
                },
                [
                  _c("span", { staticClass: "home_product_price" }, [
                    _vm._v(" " + _vm._s(newProduct.selectedPackagePrice))
                  ]),
                  _vm._v(" "),
                  _c("span", { staticClass: "home_product_currency" }, [
                    _vm._v("eur")
                  ])
                ]
              ),
              _vm._v(" "),
              newProduct.packageLength > 0
                ? _c("div", { staticClass: "mb-2" }, [
                    _c("div", { staticClass: "dropdown" }, [
                      _c(
                        "button",
                        {
                          staticClass: "btn product_atr_dropdown",
                          attrs: {
                            type: "button",
                            id: "productAtrDropdownButton",
                        ...
                        [
                          _vm._v(
                            "\n                                " +
                              _vm._s(newProduct.selectedPackageName) +
                              "\n                                "
                          ),
                          _c("i", {
                            staticClass: "fas fa-angle-down fa-border"
                          })
                        ]
                      ),
                      _vm._v(" "),
                      _c(
                        ...
                        {
                          staticClass:
                            "dropdown-menu product_atr_dropdown_show",
                          attrs: {
                            "aria-labelledby": "productAtrDropdownButton"
                          }
                        },
                        _vm._l(newProduct.packages, function(
                          newpackage,
                          pindex
                        ) {
                          return _c(
                            ...
                            [_vm._v(_vm._s(newpackage.pavadinimas))]
                          )
                        })
                      )
                    ])
              ...
              _vm._v(" "),
              _c("div", { staticClass: "d-flex" }, [
                _c("div", { staticClass: "prod_qty_field" }, [
                  _c("input", {
                    staticClass: "form-control prod_qty_field_inner",
                    attrs: {
                      type: "text",
                      value: "1",
                      id: "quantity_" + newProduct.id,
                      maxlength: "3"
                    }
                  })
                ]),
                _vm._v(" "),
                _c("div", { staticClass: "prod_qty_text mr-5" }, [
                  _vm._v(
                    "\n                            vnt.\n                        "
                  )
                ]),
                _vm._v(" "),
                _c("div", {}, [
                  _vm.added.includes(newProduct.id) == false
                    ? _c(
                        "button",
                        {
                          staticClass: "btn btn-block add_to_cart_btn",
                          on: {
                            click: function($event) {
                              _vm.addToCart(index, newProduct.id, "new_product")
                            }
                          }
                        },
                        [_vm._v("Į krepšelį")]
                    ...
                    : _vm._e(),
                  _vm._v(" "),
                  _vm.added.includes(newProduct.id)
                    ? _c(
                        "button",
                        {
                          staticClass: "btn btn-block add_to_cart_btn",
    ...
    _c("div", { staticClass: "container" }, [
      _c(
        ...
        _vm._l(_vm.bestBanners, function(bestBanner) {
          return _c("div", { staticClass: "col-sm-6 col-md-6 col-lg-6" }, [
            _c("div", { staticClass: "card" }, [
              _c("a", { attrs: { href: bestBanner.link } }, [
                _c("img", {
                  on: {
                    click: function($event) {
                      _vm.increaseClickCount(bestBanner.id)
                    }
                  }
                }),
                _c("img", {
                  staticClass: "card-img-top",
                  attrs: { src: bestBanner.img, alt: "yzipet" }
                })
              ])
            ])
          ])
    ...
    _c("div", { staticClass: "container" }, [
      _c(
        "div",
        { staticClass: "row pb-4" },
        _vm._l(_vm.bestProducts, function(bestProduct, index) {
          return _c("div", { staticClass: "col-sm-6 col-md-4 col-lg-3 mb-2" }, [
            _c("div", { attrs: { id: "home_product_item_frame_2" } }, [
              _c("div", { staticClass: "d-flex justify-content-center" }, [
                _c(
                  "a",
                  {
                  ...
                  [
                    _c("img", {
                      staticClass: "img-fluid",
                      attrs: { src: bestProduct.image, alt: "yzipet" }
                    })
                  ]
                )
              ]),
                ...
                [
                  _c("a", { attrs: { href: "#" } }, [
                    _c("img", {
                      staticClass: "img-fluid home_product_com_logo",
                      attrs: {
                        src: bestProduct.manufacturerPhoto,
                        alt: "yzipet"
                      }
                    })
                  ])
              ...
              _c("div", { staticClass: "d-sm-flex d-md-flex d-lg-flex mt-3" }, [
                _c(
                  ...
                  {
                    staticClass: "home_product_title_link",
                    attrs: { href: bestProduct.detailLink }
                  },
                  [_vm._v(_vm._s(bestProduct.title))]
                )
              ]),
              _vm._v(" "),
              _c(
                ...
                [
                  _c("span", { staticClass: "home_product_price" }, [
                    _vm._v(" " + _vm._s(bestProduct.selectedPackagePrice))
                  ]),
                  _vm._v(" "),
                  _c("span", { staticClass: "home_product_currency" }, [
                    _vm._v("eur")
                    ...
                    _c("div", { staticClass: "dropdown" }, [
                      _c(
                        ...
                        [
                          _vm._v(
                            "\n                                " +
                              _vm._s(bestProduct.selectedPackageName) +
                              "\n                                "
                          ),
                          _c("i", {
                            staticClass: "fas fa-angle-down fa-border"
                      ...
                      _c(
                        "div",
                        {
                          staticClass:
                            "dropdown-menu product_atr_dropdown_show",
                          attrs: {
                            "aria-labelledby": "productAtrDropdownButton2"
                          }
                        },
                        _vm._l(bestProduct.packages, function(
                          newpackage,
                          pindex
                        ) {
                          return _c(
              ...
              _c("div", { staticClass: "d-flex" }, [
                ...
                _vm._v(" "),
                _c("div", {}, [
                  _vm.added.includes(bestProduct.id) == false
                    ? _c(
                        "button",
                        {
                          staticClass: "btn btn-block add_to_cart_btn",
                        ...
                        [_vm._v("@lang('Į krepšelį')")]
                      )
                    : _vm._e(),
                  _vm._v(" "),
                  _vm.added.includes(bestProduct.id)
                    ? _c(
                        "button",
                        {
                          staticClass: "btn btn-block add_to_cart_btn",
    ...
    _c("div", { staticClass: "container" }, [
      _c(
        "div",
        { staticClass: "row py-3" },
        _vm._l(_vm.advantages, function(advantage) {
          return _c("div", { staticClass: "col-sm-6 col-md-6 col-lg-6" }, [
            _c(
              "div",
              ...
              [
                _c("a", { attrs: { href: "index.php" } }, [
                  _c("img", {
                    staticClass: "img-fluid",
                    attrs: { src: advantage.img, alt: "yzipet" }
                  })
                ])
              ]
            ),
            ...
            _c("div", { staticClass: "py-3 text-center" }, [
              _c("h3", {
                staticClass: "advantages_text_title",
                domProps: { innerHTML: _vm._s(advantage.title) }
              })
            ]),
            _vm._v(" "),
            _c("div", { staticClass: "text-center" }, [
              _c("p", { staticClass: "advantages_text" }, [
                _vm._v(
                  "\n                        " +
                    _vm._s(advantage.description) +
                    "\n                    "
                )
              ])
            ])
    ...
    _c("div", { attrs: { id: "footer" } }, [
      _c("div", { staticClass: "container" }, [
        _c("div", { staticClass: "row pb-2" }, [
          _c("div", { staticClass: "col-sm-12 col-md-6 col-lg-3 pt-5" }, [
            _c("table", { staticClass: "table table-borderless" }, [
              _c("tbody", [
                _c("tr", [
                  _vm._m(9),
                  _vm._v(" "),
                  _c("td", { staticClass: "footer_table_th_frame" }, [
                    _vm._m(10),
                    _vm._v(" "),
                    _c("div", { staticClass: "footer_info_txt3" }, [
                      _vm._v(_vm._s(_vm.contacts.adresas))
                    ])
                  ])
                ])
              ])
                ...
                _c("tr", [
                  ...
                  _c("td", { staticClass: "footer_table_th_frame" }, [
                    _c("div", { staticClass: "footer_info_txt3" }, [
                      _vm._v(
                        "\n                                    " +
                          _vm._s(_vm.contacts.work_hours) +
                          "\n                                "
                      )
                    ])
                  ])
...
var staticRenderFns = [
  function() {
    ...
    return _c("span", { staticClass: "input-group-append" }, [
      _c("div", { staticClass: "input-group-text search_field_icon" }, [
  ...
  function() {
    ...
    var _h = _vm.$createElement
    var _c = _vm._self._c || _h
    return _c("div", { staticClass: "col-sm-6 col-md-6 col-lg-3" }, [
      _c("table", { staticClass: "table table-borderless" }, [
        _c("tbody", [
          _c("tr", [
            _c("td", { staticClass: "top_call_td_frame" }, [
              _c("div", { staticClass: "top_call_info_icon" }, [
                _c("i", { staticClass: "fas fa-phone-square fa-2x" })
              ])
            ]),
            _vm._v(" "),
            _c("td", { staticClass: "top_call_td_frame" }, [
              _c("div", { staticClass: "top_call_info_txt1" }, [
                _vm._v(
                  "\n                                    Iškilo neaiškumų?\n                                "
                )
              ]),
              _vm._v(" "),
              _c("div", { staticClass: "top_call_info_txt2" }, [
                _vm._v(
                  "\n                                    +370 656 93284\n                                "
                )
              ])
  ...
  function() {
    ...
    var _h = _vm.$createElement
    var _c = _vm._self._c || _h
    return _c("div", { staticClass: "cart_circle_shape" }, [
      _c("a", { attrs: { href: "#" } }, [
        _c("div", { staticClass: "cart_circle_icon" })
      ])
    ])
  },
  function() {
    ...
    return _c("div", { staticClass: "container" }, [
      _c("div", { staticClass: "row pb-3" }, [
        _c("div", { staticClass: "col-sm-12 col-md-12 col-lg-12" }, [
          _c("div", { staticClass: "d-flex justify-content-center" }, [
            _c("div", { staticClass: "headliner1" }),
            _vm._v(" "),
            _c("span", { staticClass: "head_product_title_text" }, [
              _c("h3", { staticClass: "head_product_text" }, [
                _vm._v("Naujos prekės")
              ])
            ])
          ])
        ])
    ...
    return _c("div", { staticClass: "container" }, [
      _c("div", { staticClass: "row pb-3" }, [
        _c("div", { staticClass: "col" }, [
          _c("div", { staticClass: "home_prd_category_divider" })
        ])
      ])
    ])
  },
      ...
      _c("div", { staticClass: "row py-3" }, [
        _c("div", { staticClass: "col-sm-12 col-md-12 col-lg-12" }, [
          _c("div", { staticClass: "d-flex flex-row justify-content-center" }, [
            _c("h5", { staticClass: "feature_text_center" }, [
              _vm._v("Kodėl verta rinktis Yzipet")
            ])
          ])
        ])
      ])
  ...
  function() {
    ...
    return _c("div", { staticClass: "container" }, [
      _c("div", { staticClass: "row pt-2" }, [
        _c("div", { staticClass: "col-sm-12 col-md-12 col-lg-12 py-3" }, [
          _c("div", { staticClass: "d-flex flex-row" }, [
            _c("div", { staticClass: "w-50 section_div_line" }),
            _vm._v(" "),
  ...
  function() {
    ...
    var _h = _vm.$createElement
    var _c = _vm._self._c || _h
    return _c("td", { staticClass: "footer_table_th_frame" }, [
      _c("a", { attrs: { href: "index.php" } }, [
        _c("img", {
          staticClass: "img-fluid footer_info_icon",
          attrs: { alt: "yzipet" }
        })
      ])
    ])
  ...
  function() {
    ...
    var _c = _vm._self._c || _h
    return _c("div", {}, [
      _c("span", { staticClass: "footer_info_txt1" }, [_vm._v("Yzipet")]),
      _vm._v(" "),
      _c("span", { staticClass: "footer_info_txt2" }, [_vm._v("Vilniuje:")])
    ])
  },
  function() {
    var _vm = this
    ...
    return _c("div", { staticClass: "container" }, [
      _c("div", { staticClass: "row py-3" }, [
        _c("div", { staticClass: "col-sm-12 col-md-12 col-lg-12" }, [
          _c("div", { staticClass: "footer_divider_line" }, [_c("br")])
        ])
      ])
    ])
  },
  function() {
    ...
    return _c("div", { staticClass: "container" }, [
      _c("div", { staticClass: "row pt-1" }, [
        _c("div", { staticClass: "col-sm-12 col-md-12 col-lg-12" }, [
          _c("div", { staticClass: "text-center" }, [_vm._v("Socializuokimės")])
        ])
      ])
    ])
  },
  function() {
    ...
    return _c("div", { staticClass: "container" }, [
      _c("div", { staticClass: "row pt-2" }, [
        _c("div", {
          staticClass: "col-sm-12 col-md-12 col-lg-12 pb-4 text-center"
        })
      ])
    ])
  }
