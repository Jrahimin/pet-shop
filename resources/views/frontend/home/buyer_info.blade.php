    ...
    <div id="buyerInfo">
        ...
        <div class="container">
            <!--<div v-for="customerInfo in customerInfoList">
                <br/>
                <div class="row">
                    <button class="btn btn-outline-dark" style="height: 40px; width: 40px;" @click="toggleContent"><span style="color: #8a6d3b;"><i :class="toggleClass"></i></span></button>
                    <p style="text-transform: uppercase; font-size: 17px; padding-left: 10px; float: left; line-height: 32px;">@{{ customerInfo.title }}</p>
                </div>
                <div class="panel">
                    <p v-html="customerInfo.description"></p>
                </div>
            </div>-->
			
			<accordion v-for="customerInfo in customerInfoList" :title="customerInfo.title" :description="customerInfo.description">
			</accordion>
